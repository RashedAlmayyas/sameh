...
<html lang="en">
    ...
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
        ...
        <title>Dashboard - Sameh - drb <?php echo $username; ?>
</title>
...
?>
				...
				<!-- /Page Header -->
				<div class="row">
		<?php include_once("includes/card/drb.php");?>
		...
		<div class="col-md-12 d-flex">
							<div class="card card-table flex-fill">
								...
								<a href="includes/downlode/drb.php">  <button class="btn btn-primary">تنزيل البيانات</button> </a>
        </div>
									<h3 class="card-title mb-0" align="right"><?php echo htmlspecialchars($childDesc, ENT_QUOTES, 'UTF-8')   ?></h3>
								</div>
								<div class="card-body">
				<!-- table-drd -->
				<?php include_once("includes/table/drb.php");?>
