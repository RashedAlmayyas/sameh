...
?>							</ul>
		...
		<div class="row">
		<?php include_once("includes/card/lsp.php");?>
		...
		<div class="col-md-12 d-flex">
           ...
           <a href="includes/downlode/lsd.php"> <button class="btn btn-primary">تنزيل البيانات</button> </a>
        </div>
								...
								<div class="card-body">
				<!-- table-drd -->
				<?php include_once("includes/table/lsd.php");?>
