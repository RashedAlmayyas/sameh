...
?>							</ul>
		...
		<div class="row">
		<?php include_once("includes/card/drd.php");?>
		...
		<div class="col-md-12 d-flex">
							<div class="card card-table flex-fill">
								...
								<a href="includes/downlode/drd-sum.php">  <button class="btn btn-primary">تنزيل البيانات</button> </a>
        </div>
									<h3 class="card-title mb-0" align="right">احصائية <?php echo htmlspecialchars($childDesc, ENT_QUOTES, 'UTF-8')   ?></h3>
								</div>
								<div class="card-body">
				<!-- table-drd -->
				<?php include_once("includes/table/drd-sum.php");?>
			...
			<!-- /table-drd -->
						...
						<div class="col-md-12 d-flex">
							<div class="card card-table flex-fill">
								<div class="card-header">
								<div class="float-left">
								<a href="includes/downlode/drd.php">  <button class="btn btn-primary">تنزيل البيانات</button> </a>
        </div>
									<h3 class="card-title mb-0" align="right"><?php echo htmlspecialchars($childDesc, ENT_QUOTES, 'UTF-8')   ?></h3>
								</div>
								<div class="card-body">
				<!-- table-drd -->
				<?php include_once("includes/table/drd.php");?>
